...
// for display purposes
      ...
      git 'https://github.com/tataji251/hello-world-servlet.git'
...
post {
        success {
            mail to:"kopparthithathaji@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"kopparthithathaji@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
